...
int main()
{
	...
	do
	{
		...
		cout <<"12.Aggregaty na bazie danych"												<< endl << endl << endl;
		cout <<"Aby rozpoczac korzystanie z programu wcisnij 1, aby zakonczyc dzialanie programu wcisnij W."<< endl << endl << endl;
		cout<<"Dokonaj wyboru :";
